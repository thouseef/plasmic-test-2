...
export type TwitterIconSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TwitterIconSvgIcon(props: TwitterIconSvgIconProps) {
...
export default TwitterIconSvgIcon;
/* prettier-ignore-end */
